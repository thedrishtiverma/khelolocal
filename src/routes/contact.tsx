  ...
  return (
    <Page className="py-14 sm:py-24">
      <SectionHeading
        ...
        title="Let’s make local sport easier to find."
        subtitle="Have a tournament, a team, an institution, or an idea for KheloLocal? We would like to hear from you."
      />
      <div className="mt-12 grid gap-10 lg:grid-cols-[1fr_1.2fr]">
        ...
        <div className="border-t-2 border-primary bg-secondary/40 p-7 sm:p-10">
          ...
          <p className="mt-4 max-w-lg text-sm leading-7 text-muted-foreground">
            Tell us what you run, who you serve, and what would make your sports workflow easier. We
            are onboarding the first local partners city by city.
          </p>
          <a
