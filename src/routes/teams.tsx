  ...
  return (
    <Page className="py-14 sm:py-24">
      <SectionHeading
        ...
        title="Find your team. Build yours."
        subtitle="Discover the local teams, rosters and records that turn individual players into a side."
      />
      ...
      <section className="mt-16 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {[
          ...
          [ArrowRight, "Join a team", "Build your sporting profile and make the next connection."],
        ].map(([Icon, title, body]) => (
          <Link
            key={title as string}
            to="/athletes"
